...
1) **One** *event source*: It will send you a
stream of events which may or may not require clients to be notified
2) **Many** *user clients*: Each one representing a specific user,
...
with timestamp from 1 to 1000. **The events may arrive out of order**.
...
developed on: Node.js, Ruby, Ruby + EventMachine, JRuby, Haskell,
Clojure, Scala, Go, Python, Java and C/C++.*
...
1 - If your code fulfils the requirement, and runs against the
supplied example server
2 - How clean is your design and implementation, how easy it is to
understand and maintain your code
3 - How you verified your software, if by automated tests or some
other way
